...
api.post(
  '/create-role',
  isAuthenticated,
  hasPermission(DefaultPermission.Authorize),
  CreateRoleController.init()
)
...
api.put(
  ...
  isAuthenticated,
  hasPermission(DefaultPermission.Authorize),
  PutUpdatePasswordController.init()
)
...
api.put(
  ...
  isAuthenticated,
  hasPermission(DefaultPermission.Authorize),
  UpdateUserPermissionsController.init()
)
...
api.put(
  ...
  isAuthenticated,
  hasPermission(DefaultPermission.Authorize),
  UpdateRolePermissionsController.init()
)
